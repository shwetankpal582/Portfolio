import { ChevronDown, Download, Briefcase, GraduationCap } from "lucide-react";
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
            ...
            <div className="relative animate-fade-in group">
              ...
              <div className="relative">
                <div
                  className="absolute inset-0 bg-gradient-to-tr from-primary/50 to-secondary/50 rounded-full animate-spin-slow"
            ...
            <div className="flex-1 text-center md:text-left space-y-6 animate-fade-in-up">
              ...
              <p className="text-lg text-foreground/80 leading-relaxed max-w-2xl">
                I'm a results-driven Frontend Web Developer with a strong
                computer science foundation and hands-on experience building
                scalable, responsive, and business-focused web applications.
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-4">
                {[
                  ...
                  { label: "Experience", value: "Web Dev Intern" },
                  {
                    label: "UI/UX",
                    value: "Design",
                    src: "https://drive.google.com/drive/folders/19YZg0fKOVCFZ0ga-z6HHcXwRyGS0KvWY",
                  },
                ].map((stat) =>
                  stat.src ? (
                    <a
