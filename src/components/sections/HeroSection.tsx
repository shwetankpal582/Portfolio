                ...
                <div className="flex-1 text-center md:text-left space-y-6 animate-fade-in-up">
                  ...
                  <div className="flex flex-wrap justify-center md:justify-start gap-3">
                    {["React", "Tailwind", "Frontend Engineering"].map((skill) => (
                      <span
                        key={skill}
                        className="glass px-5 py-2.5 rounded-full text-sm font-medium hover:scale-105 transition-transform duration-300 cursor-default border border-primary/20 shadow-sm"
                      >
                        {skill}
                      </span>
                    ))}
                  ...
                  {/* Bio */}
                  <p className="text-lg text-foreground/90 leading-relaxed max-w-2xl lg:max-w-3xl drop-shadow-sm font-medium">
                  ...
                  <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-4">
                    {[
                      ...
                      stat.src ? (
                        ...
                        >
                          <p className="text-xs text-foreground/70 uppercase tracking-wider font-bold">{stat.label}</p>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-6">
                    ...
                    <Button size="lg" variant="outline" className="group border-primary/50 text-foreground hover:bg-primary/10 hover:border-primary transition-colors transform hover:-translate-y-0.5 duration-300 ease-out bg-background/30 backdrop-blur-sm" asChild>
